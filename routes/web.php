...
Route::middleware(['auth', 'role:2'])->group(function () {
    ...
    Route::get('/teacher/quiz/create', [GuruController::class, 'createQuiz'])->name('create.courses');
    Route::post('/teacher/quiz/store', [GuruController::class, 'storeQuiz'])->name('store.courses');
    ...
    Route::get('/teacher/quiz/{slug}/result', [GuruController::class, 'resultQuiz'])->name('result.courses');
    
    //QUESTIONS
    Route::get('/teacher/quiz/detail/{slug}', [QuizController::class, 'showQuestion'])->name('detail.courses');
    Route::get('/teacher/quiz/detail/question/{slug}/create', [QuizController::class, 'createQuestion'])->name('question.courses');
    ...
    Route::get('/teacher/quiz/detail/student/{slug}', [GuruController::class, 'createStudent'])->name('siswa.courses');
